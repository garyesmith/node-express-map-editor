    ...
    resetCurrentLocationItemButtons: function() {
        ...
        if (currentInventory.length) {
            for (var i=0; i<currentInventory.length; i++) {
                ...
                $("#buttons p.examine").append('<button data-item-id="'+currentInventory[i].id+'" data-item-name="'+currentInventory[i].name+'" data-item-examine="'+currentInventory[i].examine + '"class="examine-item bg-blue-500 text-white disabled:text-gray-200 font-mono p-3 px-4 mx-1 my-3 rounded-sm text-sm cursor-pointer disabled:cursor-auto hover:bg-blue-800 disabled:hover:bg-blue-500 disabled:opacity-30"><span class="whitespace-nowrap">EXAMINE '+ currentInventory[i].name.toUpperCase()+'</span></button> ');
